...
##In Cabinet Format
![](https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Signed_Pong_Cabinet.jpg/365px-Signed_Pong_Cabinet.jpg)
...
1. ![](http://learnstones.com/wpls/wp-content/uploads/1RedOnBlack300x300.png)
300x300 
[input type="textarea" name="1-RedOnBlack300x300" cols=80 rows=6]

2. ![](http://learnstones.com/wpls/wp-content/uploads/2.YellowOnBlack300x300.png)
300x300 
[input type="textarea" name="2-YellowOnBlack300x300" cols=80 rows=6]

3. ![](http://learnstones.com/wpls/wp-content/uploads/3.OrangeOnBlack75x75.png)
75x75
[input type="textarea" name="3-OrangeOnBlack75x75" cols=80 rows=6]

4. ![](http://learnstones.com/wpls/wp-content/uploads/4.OrangeOnBlue200x200.png)
200x200
[input type="textarea" name="4-OrangeOnBlue200x200" cols=80 rows=6]

5. ![](http://learnstones.com/wpls/wp-content/uploads/5.TwoOrangeCorners200x200.png)
200x200
[input type="textarea" name="4-TwoOrangeOnBlue200x200" cols=80 rows=6]

6. ![](http://learnstones.com/wpls/wp-content/uploads/6.TenOrangesOnBlue.png)
