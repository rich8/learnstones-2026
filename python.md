...
- Or, on the JIS network <a href="images/python-folder.png" rel="attachment wp-att-329"><img src="images/python-folder-300x87.png" alt="python-folder" width="300" height="87" class="alignnone size-medium wp-image-329" /></a>
